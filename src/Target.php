<?php
namespace Sahilr2050\YiiCloudwatchLogs;
...
class Target extends BaseTarget
{
    ...
    public function export()
    {
        ...
        $messageData = array_map([$this, 'formatMessage'], $this->messages);

        // AWS expects to receive entries in chronological order...
        usort($messageData, static function (array $a, array $b) {
